...
// configuration step. It creates a namespace called `RoundTable`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        RoundTable::cmake::project_name,
        RoundTable::cmake::project_version));// version string, acquired
